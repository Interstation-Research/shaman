...
library ShamanConfig {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "ShamanConfig", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746200000000000000000000000000005368616d616e436f6e66696700000000);
